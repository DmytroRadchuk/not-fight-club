...
const heroPull = [
    {
        ...
        description: 'A durable warrior with high health and steady attack.',
        defenseZone: []
    },
    {
        name: myStorage.getItem('playerName'),
        ...
        description: 'A glass-cannon mage with low health but deadly spells.',
        defenseZone: []
    },
    {
        name: myStorage.getItem('playerName'),
        ...
        description: 'A precise archer with balanced attack and high crit chance.',
        defenseZone: []
    },
    {
        name: myStorage.getItem('playerName'),
        ...
        description: 'A stealthy rogue with fast strikes and deadly crits.',
        defenseZone: []
    },
    {
        name: myStorage.getItem('playerName'),
...
const enemy = [
    {
        ...
        description: 'A fast spider with low health but venomous attacks.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A sneaky goblin with moderate attack and high crit chance.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A living tree with huge health but weak attacks.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A sticky slime with average stats.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A mighty dragon with high health and fire attacks.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A brutal orc with strong attack and decent health.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A fragile skeleton with high crit chance.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A tough troll with huge HP but low crit chance.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A flying harpy with sharp claws and high crit.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A sneaky bandit with dangerous backstabs.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A stone golem with enormous HP but weak damage.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A fiery phoenix with strong attacks and a chance to revive.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A shadowy wraith with deadly strikes but fragile body.',
        defenseZone: [],
        attackZones: []
    },
    {
        ...
        description: 'A furious minotaur with balanced health and power.',
        defenseZone: [],
        attackZones: []
    }
];
